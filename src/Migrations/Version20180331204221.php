 ...
 */
class Version20180331204221 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product ADD owner_id INT DEFAULT NULL, CHANGE title title VARCHAR(80) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product DROP owner_id, CHANGE title title VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
